---
title: "Chaos Game"
author: "Duduman Cristian, Moisii Lucian, Pomparau Renato-Emil"
date: "2023-02-01"
...
În matematică, termenul joc de haos a fost introdus în 1993 de Michael Barnsley .

Inițial, aceasta a fost o metodă rapidă și ușoară de a crea fractali folosind un poligon și un punct de plecare ales aleatoriu în interiorul acelui poligon. Fractalul este creat prin crearea, prin iterații succesive, a unei secvențe de puncte, pornind de la un punct inițial ales aleatoriu, pentru care fiecare punct al secvenței este poziționat la o fracție dată a distanței care separă punctul anterior de unul dintre vârfuri a poligonului. Acest vârf este ales aleatoriu la fiecare iterație. Repetând acest proces de un număr semnificativ de ori și ignorând primele puncte din secvență, un model fractal va apărea în majoritatea cazurilor.

---

## Interfata:

- *Shape*: Meniu dropdown pentru alegerea poligonului in cadrul caruia se va genera fractalul.
- *Distance ratio to endpoint*: Proportia pe baza careia va fi ales urmatorul punct in raport cu distanta de la punctul curent si varful ales aleator
- *Default value*: Distance ratio-ul indicat pentru fractalul ales.
- *Size*: Intervalul in care se va situa numarul de puncte generate de plot.
- *Number of points*: Slider prin care se alege numarul de puncte generate de plot.
...
```
<center>
<p style="font-size: 20px">Triunghi</p>
</center>
...
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, sqrt(3)/2), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.5", side=1, col="white"), xlab = "", ylab = "", bty = "n")
points(Points[1 : NMAX - 1, 1], Points[1 : NMAX - 1, 2], pch = 46, col="white")
...
<center>
<p style="font-size: 20px">Patrat</p>
</center>

```{r echo = FALSE, fig.width=5, fig.height=5, fig.show="hold", out.width="33%"}

figure = Square(0.67)
Vertices <- figure[[1]]
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.67", side=1, col="white"), xlab = "", ylab = "", bty = "n")
points(Points[1 : NMAX - 1, 1], Points[1 : NMAX - 1, 2], pch = 46, col="white")

figure = SquareRule2(0.5)
Vertices <- figure[[1]]
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.5", side=1, col="white"), xlab = "", ylab = "", bty = "n")
points(Points[1 : NMAX - 1, 1], Points[1 : NMAX - 1, 2], pch = 46, col="white")

figure = SquareRule3(0.5)
Vertices <- figure[[1]]
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.5", side=1, col="white"), xlab = "", ylab = "", bty = "n")
...
<center>
<p style="font-size: 20px">Pentagon</p>
</center>

```{r echo = FALSE, fig.width=5, fig.height=5, fig.show="hold", out.width="50%"}

figure = Pentagon(0.63)
Vertices <- figure[[1]]
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.56", side=1, col="white"), xlab = "", ylab = "", bty = "n")
points(Points[1 : NMAX - 1, 1], Points[1 : NMAX - 1, 2], pch = 46, col="white")

figure = PentagonRule2(0.56)
Vertices <- figure[[1]]
par(bg="#222222")
Points <- figure[[2]]
plot(0, 0, xlim = c(0, 1), ylim = c(0, 1), col = 0, yaxt = "n", xaxt = "n", mtext("Ratio: 0.63", side=1, col="white"), xlab = "", ylab = "", bty = "n")
points(Points[1 : NMAX - 1, 1], Points[1 : NMAX - 1, 2], pch = 46, col="white")
...
<center>
<p style="font-size: 20px">Hexagon</p>
</center>
...
<center>
<p style="font-size: 20px">Barnsley's Fern</p>
</center>
